...
//
// Экспортируется: текст ошибки attachment_too_large (см. AttachmentTray)
// подставляет число из этой же константы, а не хранит собственную копию —
// когда лимит станет приходить с сервера, текст последует за ним сам.
