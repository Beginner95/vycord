...
export const ru = {
  ...
  call: {
    ...
    mediaPermissionDenied: 'Доступ к камере и микрофону запрещён в системе. Разрешите его в Системных настройках → Конфиденциальность и безопасность → Камера / Микрофон, затем перезапустите приложение.',
